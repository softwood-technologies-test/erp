theme = {
    ...
    #Buttons
    'buttonBasic': """flex flex-grow btn btn-primary text-lg rounded-none bg-gradient-to-b from-blue-500 to-blue-700 dark:bg-gradient-to-b
    ...
    'buttonSecondary': 'flex flex-grow btn rounded-md text-lg text-white bg-gradient-to-b from-green-500 to-green-600 hover:opacity-60',
    ...
    'dialogBoxHeader': 'modal-header bg-base-300 dark:bg-neutral text-base-content p-4',
